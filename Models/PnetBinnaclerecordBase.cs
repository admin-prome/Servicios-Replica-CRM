...
public partial class PnetBinnaclerecordBase
{
    public Guid? PnetBinnaclerecordId { get; set; }
    ...
    public string? PnetFulladdress { get; set; }

    public string? PnetLocality { get; set; }
    ...
    public DateTime? PnetLastpaymentdate { get; set; }

    public int? PnetLatepaymentdays { get; set; }

    public decimal? PnetClaimabledebt { get; set; }

    public string? PnetSitoperation { get; set; }
    ...
    public decimal? PnetCumulativepayments { get; set; }

    public DateTime? PnetNextexpirationdate { get; set; }

    public DateTime? PnetCoupondate { get; set; }

    public int? PnetSittar { get; set; }

    public string? PnetAccountstatus { get; set; }

    public int? PnetCal2180 { get; set; }

    public decimal? PnetDeu2180 { get; set; }

    public string? PnetSit2180 { get; set; }

    public string? PnetFec2180 { get; set; }
    ...
    public int? PnetAccounttype { get; set; }

    public long? PnetAccountnumber { get; set; }

    public string? PnetAccount { get; set; }

    public string? PnetAvAccountNumber { get; set; }

    public string? PnetAvBranchLoan { get; set; }

    public string? PnetAvProductNumber { get; set; }
    ...
    public string? PnetAccountMaster { get; set; }
